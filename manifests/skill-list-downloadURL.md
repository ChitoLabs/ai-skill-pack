...
Derived from the active `.ld9/skill-list-downloadURL.md` and filtered to entries represented by the published general `skills/` folder.
...
| Metric | Count |
| --- | ---: |
| Active source list entries | 487 |
| Entries represented in published skills | 454 |
...
- `image-to-video` (source: `imnage-to-video`) — https://www.skills.sh/agentspace-so/runcomfy-agent-skills/image-to-video
...
- `openai-docs` (source: `openapi-docs`) — https://www.skills.sh/openai/skills/openai-docs
...
- `postgresql-table-design` (source: `postgresql`) — https://github.com/wshobson/agents/tree/HEAD/plugins/database-design/skills/postgresql
...
- `pr-review` (source: `pr_review`) — https://skills.sh/angular/angular/pr_review
...
- `pwa-development` (source: `pwa`) — https://skills.sh/mindrally/skills/pwa-development
...
- `sqlalchemy-orm` (source: `sqlalchemy`) — https://skills.sh/bobmatnyc/claude-mpm-skills/sqlalchemy
...
- `stitch-code-to-design` (source: `stitch-design`) — https://github.com/google-labs-code/stitch-skills/tree/HEAD/plugins/stitch-design
