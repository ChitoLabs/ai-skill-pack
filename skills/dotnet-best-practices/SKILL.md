...
metadata:
  ...
  github_url: "https://github.com/github/awesome-copilot/tree/HEAD/skills/dotnet-best-practices"
---

## Activation Contract

Use this skill when the user request matches `dotnet-best-practices` or the preserved source description: Ensure .NET/C# code meets best practices for the solution/project.
