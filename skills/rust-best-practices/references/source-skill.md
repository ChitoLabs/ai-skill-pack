...
- [Chapter 1 - Coding Styles and Idioms](chapter_01.md): Borrowing vs cloning, Copy trait, Option/Result handling, iterators, comments
- [Chapter 2 - Clippy and Linting](chapter_02.md): Clippy configuration, important lints, workspace lint setup
- [Chapter 3 - Performance Mindset](chapter_03.md): Profiling, avoiding redundant clones, stack vs heap, zero-cost abstractions
- [Chapter 4 - Error Handling](chapter_04.md): Result vs panic, thiserror vs anyhow, error hierarchies
- [Chapter 5 - Automated Testing](chapter_05.md): Test naming, one assertion per test, snapshot testing
- [Chapter 6 - Generics and Dispatch](chapter_06.md): Static vs dynamic dispatch, trait objects
- [Chapter 7 - Type State Pattern](chapter_07.md): Compile-time state safety, when to use it
- [Chapter 8 - Comments vs Documentation](chapter_08.md): When to comment, doc comments, rustdoc
- [Chapter 9 - Understanding Pointers](chapter_09.md): Thread safety, Send/Sync, pointer types
