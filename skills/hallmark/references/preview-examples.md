...
Four sample preview blocks varied across macrostructure types. Load this file only when an unusual macrostructure or custom theme needs more scaffolding than [build workflow: Preview and Approval](workflows/build.md#phase-7-preview-and-approval). Most builds do not need it.
...
>
> - **Macrostructure** * Long Document
> - **Theme** * custom (vibe: "archival warmth, hand-set, no varnish" * paper oklch(94% 0.020 65) * accent oklch(58% 0.16 35) terracotta * Fraunces roman display + Source Serif 4 body)
