...
- **Lead:** italic display setting a real customer's attributed `blockquote` (36-60 px), with attribution below in small caps. The page heading remains roman.
...
`recipe-exception: quote-led-italic`
