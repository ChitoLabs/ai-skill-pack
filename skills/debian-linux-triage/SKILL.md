...
description: "Trigger: debian-linux-triage, Triage and resolve Debian Linux issues with apt, systemd, and AppArmor-aware guidance. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: github
  adapter: LCubero
...
Use this skill when the user request matches `debian-linux-triage` or the preserved source description: Triage and resolve Debian Linux issues with apt, systemd, and AppArmor-aware guidance.
