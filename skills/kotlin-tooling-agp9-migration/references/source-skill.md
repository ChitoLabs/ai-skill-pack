...
See [references/MIGRATION-LIBRARY.md](MIGRATION-LIBRARY.md) for full before/after code.
...
See [references/MIGRATION-APP-SPLIT.md](MIGRATION-APP-SPLIT.md) for full guide.
...
See [references/MIGRATION-FULL-RESTRUCTURE.md](MIGRATION-FULL-RESTRUCTURE.md) for full guide.
...
See [references/PLUGIN-COMPATIBILITY.md](PLUGIN-COMPATIBILITY.md) for the full compatibility table with known compatible versions, opt-out flag workarounds, and broken plugins.
