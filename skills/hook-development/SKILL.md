...
Use this skill when the user request matches `hook-development` or the preserved source description: Complete Claude Code hooks reference - input/output schemas, registration, testing patterns
