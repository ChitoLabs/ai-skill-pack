...
Use this skill when the user request matches `workers-best-practices` or the preserved source description: Reviews and authors Cloudflare Workers code against production best practices. Load when writing new Workers, reviewing Worker code, configuring wrangler.jsonc, or checking for common Workers anti-patterns (streaming, floating promises, global state, secrets, bindings, observability). Biases towards retrieval from Cloudflare docs over pre-trained knowledge.
...
- `references/review.md` - preserved source companion file.
- `references/rules.md` - preserved source companion file.
