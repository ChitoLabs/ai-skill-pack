...
Use this skill when the user request matches `python-patterns` or the preserved source description: Pythonic idioms, PEP 8 standards, type hints, and best practices for building robust, efficient, and maintainable Python applications.
