...
metadata:
  author: wondelai
  version: 1.1.0
  skills_sh_url: "https://www.skills.sh/wondelai/skills/system-design"
  github_url: "https://github.com/wondelai/skills/tree/HEAD/system-design"
---
...
See: [references/four-step-process.md](four-step-process.md)
...
See: [references/estimation-numbers.md](estimation-numbers.md)
...
See: [references/building-blocks.md](building-blocks.md)
...
See: [references/database-scaling.md](database-scaling.md)
...
See: [references/common-designs.md](common-designs.md)
...
See: [references/reliability-operations.md](reliability-operations.md)
...
- [four-step-process.md](four-step-process.md): The complete four-step process with time allocation, example questions, and tips for each stage
- [estimation-numbers.md](estimation-numbers.md): Powers of two, latency numbers, availability nines, QPS/storage/bandwidth estimation with worked examples
- [building-blocks.md](building-blocks.md): DNS, CDN, load balancers, caching strategies, message queues, consistent hashing
- [database-scaling.md](database-scaling.md): SQL vs NoSQL, replication, sharding strategies, denormalization, database selection guide
- [common-designs.md](common-designs.md): URL shortener, rate limiter, news feed, chat system, search autocomplete, web crawler, unique ID generator
- [reliability-operations.md](reliability-operations.md): Health checks, monitoring, logging, deployment strategies, disaster recovery, autoscaling
