...
This guide provides comprehensive documentation for the **graphql** skill in the custom-plugin-nodejs plugin.
...
```bash
# Invoke the skill
claude "graphql - [your task description]"

# Example
claude "graphql - analyze the current implementation"
```
...
def implement_graphql(input_data):
    """
