...
- [python-testing-patterns](related-skills/python-testing-patterns.md) — Test each layer in isolation using the dependency injection structure established here
