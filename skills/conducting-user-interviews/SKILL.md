...
Use this skill when the user request matches `conducting-user-interviews` or the preserved source description: Help users run better customer and user interviews. Use when someone is preparing for user research, planning discovery interviews, writing interview questions, analyzing interview findings, or trying to understand customer needs.
...
- `references/guest-insights.md` - preserved source companion file.
