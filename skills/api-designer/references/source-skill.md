...
|-------|-----------|-----------|
| REST Patterns | `rest-patterns.md` | Resource design, HTTP methods, HATEOAS |
| Versioning | `versioning.md` | API versions, deprecation, breaking changes |
| Pagination | `pagination.md` | Cursor, offset, keyset pagination |
| Error Handling | `error-handling.md` | Error responses, RFC 7807, status codes |
| OpenAPI | `openapi.md` | OpenAPI 3.1, documentation, code generation |
