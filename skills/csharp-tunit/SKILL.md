...
metadata:
  ...
  github_url: "https://github.com/github/awesome-copilot/tree/HEAD/skills/csharp-tunit"
---
...
Use this skill when the user request matches `csharp-tunit` or one of its declared triggers: write or review TUnit unit tests or data-driven tests. Apply current TUnit practices to a defined test task.
