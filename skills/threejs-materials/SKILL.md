...
Use this skill when the user request matches `threejs-materials` or the preserved source description: Three.js materials - PBR, basic, phong, shader materials, material properties. Use when styling meshes, working with textures, creating custom shaders, or optimizing material performance.
