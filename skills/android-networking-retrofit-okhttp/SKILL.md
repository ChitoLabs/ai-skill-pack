...
Use this skill when the user request matches `android-networking-retrofit-okhttp` or the preserved source description: Build Android networking stacks with Retrofit, OkHttp, interceptors, API contracts, and resilient error handling.
