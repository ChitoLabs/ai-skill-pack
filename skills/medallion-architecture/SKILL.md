...
Use this skill when the user request matches `medallion-architecture` or the preserved source description: Bronze/Silver/Gold layer design patterns and templates for building scalable data lakehouse architectures. Includes incremental processing, data quality checks, and optimization strategies.
