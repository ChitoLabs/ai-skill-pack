...
Use this skill when the user request matches `enhance-prompt` or the preserved source description: Transforms vague UI ideas into polished, Stitch-optimized prompts. Enhances specificity, adds UI/UX keywords, injects design system context, and structures output for better generation results.
...
- `references/KEYWORDS.md` - preserved source companion file.
