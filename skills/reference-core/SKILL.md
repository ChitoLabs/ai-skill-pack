...
Use this skill when the user request matches `reference-core` or the preserved source description: Explains the mental model and architecture of the code under `packages/core`. You MUST use this skill any time you plan to work with code in `packages/core`
