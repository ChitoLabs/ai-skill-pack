...
Use this skill when the user request matches `android-testing-unit` or the preserved source description: Write fast, focused Android unit tests for reducers, use cases, repositories, and lifecycle-safe state holders.
