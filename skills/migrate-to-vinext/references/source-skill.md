...
See [references/compatibility.md](compatibility.md) for supported/unsupported features and ecosystem library status.
...
See [references/config-examples.md](config-examples.md) for config variants per router and deployment target.
...
For manual setup or custom worker entries, see [references/config-examples.md](config-examples.md).
