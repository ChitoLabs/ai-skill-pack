...
metadata:
  ...
  github_url: "https://github.com/krutikJain/android-agent-skills"
---

## Activation Contract

Use this skill when the user request matches `android-kotlin-core` or the preserved source description: Use Kotlin idioms safely in Android apps, including nullability, data classes, sealed types, extension functions, and collection pipelines.
...
- `references/official-links.md` - preserved source companion file.
- `references/patterns.md` - preserved source companion file.
- `references/scenarios.md` - preserved source companion file.
- `scripts/run_examples.sh` - preserved source companion file.
