...
description: "Trigger: social-media-generator, This skill should be used when the user requests social media content creation for Twitter, Instagram, LinkedIn, or Facebook. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: ailabs-393
  version: 0.1
...
- `assets/facebook_template.md` - preserved source companion file.
- `assets/instagram_template.md` - preserved source companion file.
- `assets/linkedin_template.md` - preserved source companion file.
- `assets/twitter_template.md` - preserved source companion file.
