...
Use this skill when the user request matches `reference-signal-forms` or the preserved source description: Explains the mental model and architecture of the code under `packages/forms/signals`. You MUST use this skill any time you plan to work with code in `packages/forms/signals`
...
- `references/integration.md` - preserved source companion file.
