---
name: nginx-expert
description: "Trigger: nginx-expert, Expert-level Nginx configuration, reverse proxy, load balancing, SSL/TLS, caching, and performance tuning. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
...
Use this skill when the user request matches `nginx-expert` or the preserved source description: Expert-level Nginx configuration, reverse proxy, load balancing, SSL/TLS, caching, and performance tuning
