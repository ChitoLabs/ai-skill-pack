...
|-------|-----------|-----------|
| DataFrame Operations | `dataframe-operations.md` | Indexing, selection, filtering, sorting |
| Data Cleaning | `data-cleaning.md` | Missing values, duplicates, type conversion |
| Aggregation & GroupBy | `aggregation-groupby.md` | GroupBy, pivot, crosstab, aggregation |
| Merging & Joining | `merging-joining.md` | Merge, join, concat, combine strategies |
| Performance Optimization | `performance-optimization.md` | Memory usage, vectorization, chunking |
