...
Read [skills/extract-static-html/SKILL.md](source-skill.md) for detailed instructions and script usage.
...
[skills/extract-design-md/SKILL.md](source-skill.md) for the
...
[skills/manage-design-system/SKILL.md](source-skill.md) for
...
Read [skills/upload-to-stitch/SKILL.md](source-skill.md) for detailed instructions and script usage.
