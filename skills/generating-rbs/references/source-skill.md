...
metadata:
  ...
  version: 0.1
  skills_sh_url: "https://skills.sh/DmitryPogrebnoy/ruby-agent-skills/generating-rbs"
  github_url: "https://github.com/DmitryPogrebnoy/ruby-agent-skills/tree/HEAD/plugins/ruby-type-signature-skills/skills/generating-rbs"
---
...
- You need to strongly follow RBS syntax conventions to describe types for all declarations
  - See [syntax.md](syntax.md) for the full list of RBS types. Double-check it in tricky cases.
- Take inspiration from RBS signature examples
  - See [rbs_by_example.md](rbs_by_example.md) for short list of RBS signatures examples
  - See [core](rbs_examples/core/STRUCTURE.md) for RBS signatures of Ruby core library
  - See [stdlib](rbs_examples/stdlib/STRUCTURE.md) for RBS signatures of Ruby standard library
  - Pay extra attention to `Data` and `Struct` types. See [data_and_struct.md](data_and_struct.md) for handling guide
...
- [syntax.md](syntax.md) - The full list of RBS types and syntax
- [rbs_by_example.md](rbs_by_example.md) - Short list of RBS signatures examples
- [core](rbs_examples/core/STRUCTURE.md) - RBS signatures of Ruby core library
- [stdlib](rbs_examples/stdlib/STRUCTURE.md) - RBS signatures of Ruby standard library
- [data_and_struct.md](data_and_struct.md) - Explanation on `Data` and `Struct` types handling