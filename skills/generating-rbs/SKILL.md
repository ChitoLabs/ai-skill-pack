---
name: generating-rbs
description: "Trigger: generating-rbs, Generate or update RBS type signatures for Ruby source files in separate .rbs files. Preserve source workflow with portable agent instructions."
license: MIT
metadata:
...
Use this skill when the user request matches `generating-rbs` or the preserved source description: Generate or update RBS type signatures for Ruby source files in separate .rbs files
