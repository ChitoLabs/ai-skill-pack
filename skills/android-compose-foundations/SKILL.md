...
Use this skill when the user request matches `android-compose-foundations` or the preserved source description: Build Android UI with Jetpack Compose foundations, layouts, modifiers, theming, and stable component structure.
