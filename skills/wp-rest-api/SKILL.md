...
- `references/custom-content-types.md` - preserved source companion file.
- `references/discovery-and-params.md` - preserved source companion file.
- `references/responses-and-fields.md` - preserved source companion file.
- `references/routes-and-endpoints.md` - preserved source companion file.
- `references/schema.md` - preserved source companion file.
