...
description: "Trigger: deno-typescript, Guidelines for developing with Deno and TypeScript using modern runtime features, security model, and native tooling. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: mindrally
  adapter: LCubero
...
Use this skill when the user request matches `deno-typescript` or the preserved source description: Guidelines for developing with Deno and TypeScript using modern runtime features, security model, and native tooling
