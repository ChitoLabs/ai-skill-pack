...
- `references/spec-document-reviewer-prompt.md` - preserved source companion file.
- `references/visual-companion.md` - preserved source companion file.
- `scripts/frame-template.html` - preserved source companion file.
- `scripts/helper.js` - preserved source companion file.
- `scripts/server.cjs` - preserved source companion file.
- `scripts/start-server.sh` - preserved source companion file.
- `scripts/stop-server.sh` - preserved source companion file.
