...
Use this skill when the user request matches `javascript-typescript-jest` or the preserved source description: Best practices for writing JavaScript/TypeScript tests using Jest, including mocking strategies, test structure, and common patterns.
