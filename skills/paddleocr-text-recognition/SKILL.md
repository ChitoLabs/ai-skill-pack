...
- `references/output_schema.md` - preserved source companion file.
- `scripts/lib.py` - preserved source companion file.
- `scripts/ocr_caller.py` - preserved source companion file.
- `scripts/smoke_test.py` - preserved source companion file.
