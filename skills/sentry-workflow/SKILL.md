...
Use this skill when the user request matches `sentry-workflow` or the preserved source description: Fix production issues and review code with Sentry context. Use when asked to fix Sentry errors, debug issues, triage exceptions, review PR comments from Sentry, or resolve bugs.
