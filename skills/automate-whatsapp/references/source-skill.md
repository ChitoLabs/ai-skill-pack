...
metadata:
  author: gokapso
  version: 0.1
  skills_sh_url: "https://skills.sh/gokapso/agent-skills/automate-whatsapp"
  github_url: "https://github.com/gokapso/agent-skills/tree/HEAD/skills/automate-whatsapp"
---
...
Use `kapso push` to push every local function and workflow. See `local-workflow-source.md` for repo layout, source-file behavior, and JSON-only editing.
...
1. Read `agent-remote-sandbox.md` for the execution model and field rules
...
- Use `agent-remote-sandbox.md` and `node-types.md` for the exact shape
...
For full schema details, see `graph-contract.md`.
...
Read before editing:
- [references/local-workflow-source.md](local-workflow-source.md) - CLI source sync, repo layout, and `@kapso/workflows`
- [references/graph-contract.md](graph-contract.md) - Graph schema, computed vs editable fields, lock_version
- [references/node-types.md](node-types.md) - Node types and config shapes
- [references/workflow-overview.md](workflow-overview.md) - Execution flow and states

Other references:
- [references/execution-context.md](execution-context.md) - Context structure and variable substitution
- [references/triggers.md](triggers.md) - Trigger types and setup
- [references/agent-remote-sandbox.md](agent-remote-sandbox.md) - Remote sandbox behavior, repo resources, mounted paths
- [references/functions-reference.md](functions-reference.md) - Function management
- [references/functions-payloads.md](functions-payloads.md) - Payload shapes for functions
