...
- `references/SEARCH_GUIDE.md` - preserved source companion file.
- `references/VALIDATION_GUIDE.md` - preserved source companion file.
- `references/WORKFLOW_GUIDE.md` - preserved source companion file.
