...
- For the detailed audit checklist, see [references/spm-analysis-checks.md](spm-analysis-checks.md)
- For the shared recommendation structure, see [references/recommendation-format.md](recommendation-format.md)
- For source citations, see [references/build-optimization-sources.md](build-optimization-sources.md)
