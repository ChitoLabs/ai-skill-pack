---
name: drizzle
description: "Trigger: drizzle, Type-safe SQL ORM for TypeScript with zero runtime overhead. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: bobmatnyc
  adapter: LCubero
...
Use this skill when the user request matches `drizzle` or the preserved source description: Type-safe SQL ORM for TypeScript with zero runtime overhead
...
- `references/advanced-schemas.md` - preserved source companion file.
...
- `references/vs-prisma.md` - preserved source companion file.
