...
description: "Trigger: whatsapp-automation, WhatsApp Business automation - customer support, notifications, chatbots, and broadcast messaging. Preserve source workflow with portable agent instructions."
license: MIT
metadata:
...
Use this skill when the user request matches `whatsapp-automation` or the preserved source description: WhatsApp Business automation - customer support, notifications, chatbots, and broadcast messaging
