...
Use this skill when the user request matches `django-patterns` or the preserved source description: Django architecture patterns, REST API design with DRF, ORM best practices, caching, signals, middleware, and production-grade Django apps.
