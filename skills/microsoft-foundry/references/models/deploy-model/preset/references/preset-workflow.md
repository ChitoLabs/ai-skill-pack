...
This file contains the full step-by-step bash/PowerShell scripts for preset (optimal region) model deployment. Referenced from the main [SKILL.md](../../../../source-skill.md).
...
The upstream skill refers to a `generate_deployment_name` script to check existing deployments and generate a unique name:
