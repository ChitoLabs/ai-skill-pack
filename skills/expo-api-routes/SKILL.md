...
description: "Trigger: expo-api-routes, Guidelines for creating API routes in Expo Router with EAS Hosting. Preserve source workflow with portable agent instructions."
license: MIT
metadata:
  author: expo
  adapter: LCubero
...
Use this skill when the user request matches `expo-api-routes` or the preserved source description: Guidelines for creating API routes in Expo Router with EAS Hosting
