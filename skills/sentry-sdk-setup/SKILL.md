...
description: "Trigger: add Sentry, install a Sentry SDK, configure error monitoring. Detect the selected platform and route to the appropriate setup workflow."
license: Apache-2.0
metadata:
  author: getsentry
  adapter: LCubero
...
- `references/related-skills/sentry-node-sdk.md` - preserved Node.js/Bun/Deno Sentry SDK companion.
...
- `references/related-skills/sentry-react-sdk.md` - preserved React Sentry SDK companion.
