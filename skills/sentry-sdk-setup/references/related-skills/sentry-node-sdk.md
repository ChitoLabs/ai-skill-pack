...
> [All Skills](../SKILL_TREE.md) > `sentry-sdk-setup` > Node.js / Bun / Deno SDK
...
> **NestJS?** Use [`sentry-nestjs-sdk`](../SKILL_TREE.md) instead — it uses `@sentry/nestjs` with NestJS-native decorators and filters.
> **Next.js?** Use [`sentry-nextjs-sdk`](../SKILL_TREE.md) instead — it handles the three-runtime architecture (browser, server, edge).
...
> **Use the [`sentry-nestjs-sdk`](../SKILL_TREE.md) skill instead.**
...
| NestJS | → Use [`sentry-nestjs-sdk`](../SKILL_TREE.md) | Dedicated skill | — |
...
| Metrics | `sentry-node-sdk/references/metrics.md` | Custom counters, gauges, distributions |
| Runtime Metrics | See inline below | Automatic memory, CPU, and event loop metrics for Node.js and Bun |
| Crons | `sentry-node-sdk/references/crons.md` | Scheduled job monitoring, node-cron, Bull, Agenda, Deno.cron |
...
|----------|-------------|-----|
| NestJS (`@nestjs/core` in `package.json`) | [`sentry-nestjs-sdk`](../SKILL_TREE.md) | Uses `@sentry/nestjs` with NestJS-native decorators, filters, and GraphQL support |
| Next.js (`next` in `package.json`) | [`sentry-nextjs-sdk`](../SKILL_TREE.md) | Three-runtime architecture (browser, server, edge), `withSentryConfig`, source map upload |
...
| Svelte/SvelteKit | [`sentry-svelte-sdk`](../SKILL_TREE.md) |

**Other backend companions:**

| Detected | Suggest |
|---------|---------|
| Go backend (`go.mod`) | [`sentry-go-sdk`](../SKILL_TREE.md) |
| Python backend (`requirements.txt`, `pyproject.toml`) | [`sentry-python-sdk`](../SKILL_TREE.md) |
| Ruby backend (`Gemfile`) | [`sentry-ruby-sdk`](../SKILL_TREE.md) |
...
| NestJS: errors not captured | Wrong SDK or missing filter | Use [`sentry-nestjs-sdk`](../SKILL_TREE.md) — NestJS needs `@sentry/nestjs`, not `@sentry/node` |
