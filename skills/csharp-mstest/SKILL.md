...
metadata:
  ...
  github_url: "https://github.com/github/awesome-copilot/tree/HEAD/skills/csharp-mstest"
---
...
Use this skill when the user request matches `csharp-mstest` or one of its declared triggers: write or review MSTest unit tests, assertions, or data-driven tests. Apply current MSTest practices to a defined test task.
