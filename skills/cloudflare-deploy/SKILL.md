...
Use this skill when the user request matches `cloudflare-deploy` or the preserved source description: Deploy applications and infrastructure to Cloudflare using Workers, Pages, and related platform services. Use when the user asks to deploy, host, publish, or set up a project on Cloudflare.
...
- `assets/cloudflare-small.svg` - preserved source companion file.
- `assets/cloudflare.png` - preserved source companion file.
...
- `references/wrangler/auth.md` - preserved source companion file.
