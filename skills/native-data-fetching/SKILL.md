...
Use this skill when the user request matches `native-data-fetching` or the preserved source description: Use when implementing or debugging ANY network request, API call, or data fetching. Covers fetch API, React Query, SWR, error handling, caching, offline support, and Expo Router data loaders (`useLoaderData`).
...
- `references/expo-router-loaders.md` - preserved source companion file.
