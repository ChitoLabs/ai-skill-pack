...
Use this skill when the user request matches `accessibility-a11y` or the preserved source description: Implement web accessibility (a11y) best practices following WCAG guidelines to create inclusive, accessible user interfaces.
