...
Change `project.pbxproj` values to match the recommendations in [build-settings-best-practices.md](build-settings-best-practices.md).
...
Apply code changes that reduce type-checker and compiler overhead. See [references/fix-patterns.md](fix-patterns.md) for before/after patterns.
...
- For concrete before/after fix patterns, see [references/fix-patterns.md](fix-patterns.md)
- For build settings best practices, see [references/build-settings-best-practices.md](build-settings-best-practices.md)
- For the recommendation format, see [references/recommendation-format.md](recommendation-format.md)
