---
name: elasticsearch
description: "Trigger: elasticsearch, Elasticsearch development best practices for indexing, querying, and search optimization. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: mindrally
  adapter: LCubero
...
Use this skill when the user request matches `elasticsearch` or the preserved source description: Elasticsearch development best practices for indexing, querying, and search optimization
