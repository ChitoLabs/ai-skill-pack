---
name: discord
description: "Trigger: discord, Discord message-tool ops: send/read/edit/delete, react, poll, pin, thread, search, presence, media/components. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: steipete
  adapter: LCubero
...
Use this skill when the user request matches `discord` or the preserved source description: Discord message-tool ops: send/read/edit/delete, react, poll, pin, thread, search, presence, media/components.
