...
See [Connection detection](https://docs.kapso.ai/docs/platform/detecting-whatsapp-connection) for handling successful connections.
...
Both URLs receive query parameters with setup details. See [Connection detection](https://docs.kapso.ai/docs/platform/detecting-whatsapp-connection) for handling redirects and available parameters.
