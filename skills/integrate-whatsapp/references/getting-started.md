...
- [Setup links](https://docs.kapso.ai/docs/platform/setup-links) - Customize redirect URLs, branding, connection types
- [Connection detection](https://docs.kapso.ai/docs/platform/detecting-whatsapp-connection) - Know when customers connect
- [Webhooks](https://docs.kapso.ai/docs/platform/webhooks/overview) - Handle real-time message events
