...
metadata:
  ...
  github_url: "https://github.com/hashicorp/agent-skills/tree/HEAD/plugins/terraform/skills/terraform-style-guide"
---

## Activation Contract

Use this skill when the user request matches `terraform-style-guide` or the preserved source description: Generate Terraform HCL code following HashiCorp's official style conventions and best practices. Use when writing, reviewing, or generating Terraform configurations.
