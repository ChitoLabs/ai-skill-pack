...
> [All Skills](SKILL_TREE.md) > [SDK Setup](related-skills/sentry-sdk-setup.md) > Node.js / Bun / Deno SDK
...
| Detected | Suggest |
|---------|---------|
| React app (`react` in `package.json`) | [`sentry-react-sdk`](related-skills/sentry-react-sdk.md) |
