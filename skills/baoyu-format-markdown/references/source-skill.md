...
**Generate candidates** using formulas from `title-formulas.md`:
...
Put the strongest hook first and mark it `(recommended)`. See `title-formulas.md` for principles and prohibited patterns.
