---
name: openai-docs
description: "Trigger: openai-docs. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: openai
  adapter: LCubero
...
Use this skill when the user request matches `openai-docs` or the preserved source description: Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations, help choosing the latest model for a use case, or model upgrade and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains.
...
- `assets/openai-small.svg` - preserved source companion file.
- `assets/openai.png` - preserved source companion file.
- `references/LICENSE.txt` - preserved source companion file.
- `references/agents/openai.yaml` - preserved source companion file.
- `references/latest-model.md` - preserved source companion file.
- `references/prompting-guide.md` - preserved source companion file.
- `references/upgrade-guide.md` - preserved source companion file.
- `scripts/resolve-latest-model-info.js` - preserved source companion file.
