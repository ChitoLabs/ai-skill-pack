...
- `references/airflow-patterns.md` - preserved source companion file.
- `references/dbt-patterns.md` - preserved source companion file.
- `references/evals.json` - preserved source companion file.
- `references/spark-tuning.md` - preserved source companion file.
- `references/streaming-architecture.md` - preserved source companion file.
