...
metadata:
  ...
  github_url: "https://github.com/dammyjay93/interface-design/tree/HEAD/.claude/skills/interface-design"
---
...
- `references/critique.md` - preserved source companion file.
- `references/example.md` - preserved source companion file.
- `references/principles.md` - preserved source companion file.
- `references/validation.md` - preserved source companion file.
