...
Use this skill when the user request matches `rust-mcp-server-generator` or the preserved source description: Generate a complete Rust Model Context Protocol server project with tools, prompts, resources, and tests using the official rmcp SDK
