...
- Follow RBS-inline syntax conventions strictly
  - See [syntax.md](syntax.md) for the full RBS-inline syntax guide
- Pay extra attention to `Data` and `Struct` types
  - See [data-struct-support.md](data-struct-support.md) for Data and Struct handling
...
- [syntax.md](syntax.md) - RBS-inline syntax guide
- [data-struct-support.md](data-struct-support.md) - Data and Struct handling in rbs-inline
- [examples/](rbs_inline_examples/STRUCTURE.md) - Real-world rbs-inline examples from production gems
