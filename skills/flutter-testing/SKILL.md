...
description: "Trigger: flutter-testing, Write, fix, review, debug, and validate Flutter tests for apps, packages, and plugins. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: madteacher
  version: 2.0
...
- `references/integration-testing.md` - preserved source companion file.
- `references/mocking.md` - preserved source companion file.
- `references/plugin-testing.md` - preserved source companion file.
- `references/unit-testing.md` - preserved source companion file.
- `references/widget-testing.md` - preserved source companion file.
- `scripts/verify-examples.sh` - preserved source companion file.
