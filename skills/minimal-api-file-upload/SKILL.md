...
metadata:
  ...
  github_url: "https://github.com/dotnet/skills/tree/HEAD/plugins/dotnet-aspnetcore/skills/minimal-api-file-upload"
---

## Activation Contract

Use this skill when the user request matches `minimal-api-file-upload` or the preserved source description: File upload endpoints in ASP.NET minimal APIs (.NET 8+)
