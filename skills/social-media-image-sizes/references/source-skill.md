...
- `instagram.md` — profile, feed, stories, reels, carousel, ads
- `facebook.md` — profile, cover, feed, stories, events, ads
- `x-twitter.md` — profile, header, posts, ads
- `linkedin.md` — profile, cover, feed, articles, ads
- `tiktok.md` — profile, videos, ads
- `youtube.md` — channel art, videos, thumbnails, shorts, ads
- `pinterest.md` — profile, pins, idea pins, ads
- `snapchat.md` — snaps, spotlight, stories, ads, filters
- `threads.md` — profile, posts
- `best-practices.md` — format, compression, safe zones, accessibility
