...
Use this skill when the user request matches `tanstack-start` or the preserved source description: Full-stack React framework powered by TanStack Router with SSR, streaming, server functions, and deployment to any hosting provider.
