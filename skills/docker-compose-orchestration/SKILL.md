...
Use this skill when the user request matches `docker-compose-orchestration` or the preserved source description: Container orchestration with Docker Compose for multi-container applications, networking, volumes, and production deployment
...
- `references/.skill-info.txt` - preserved source companion file.
