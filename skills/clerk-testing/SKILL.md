---
name: clerk-testing
description: "Trigger: clerk-testing, E2E testing for Clerk apps. Preserve source workflow with portable agent instructions."
license: MIT
metadata:
  author: clerk
  version: 1.2.0
...
Use this skill when the user request matches `clerk-testing` or the preserved source description: E2E testing for Clerk apps. Use with Playwright or Cypress for auth flow
