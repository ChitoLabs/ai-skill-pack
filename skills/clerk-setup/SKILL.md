...
metadata:
  author: clerk
  version: 2.3.0
  skills_sh_url: "https://skills.sh/clerk/skills/clerk-setup"
  github_url: "https://github.com/clerk/skills/tree/HEAD/skills/core/clerk-setup"
---

## Activation Contract

Use this skill when the user request matches `clerk-setup` or the preserved source description: Add Clerk authentication to any project by following the official quickstart
