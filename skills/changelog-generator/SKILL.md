...
metadata:
  ...
  github_url: "https://github.com/composiohq/awesome-claude-skills/tree/HEAD/changelog-generator"
---

## Activation Contract

Use this skill when the user request matches `changelog-generator` or the preserved source description: Automatically creates user-facing changelogs from git commits by analyzing commit history, categorizing changes, and transforming technical commits into clear, customer-friendly release notes. Turns hours of manual changelog writing into minutes of automated generation.
