...
- [Tool Builder](tool-builder.md) - Complete tool builder API reference
...
- [Sessions](sessions.md) - Stateful execution with warm workers
- [Async Patterns](async-patterns.md) - Parallel processing and async/await
