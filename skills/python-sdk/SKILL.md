...
- `references/agent-patterns.md` - preserved source companion file.
- `references/async-patterns.md` - preserved source companion file.
- `references/files.md` - preserved source companion file.
- `references/sessions.md` - preserved source companion file.
- `references/streaming.md` - preserved source companion file.
- `references/tool-builder.md` - preserved source companion file.
