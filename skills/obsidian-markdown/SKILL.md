...
metadata:
  ...
  github_url: "https://github.com/kepano/obsidian-skills/tree/HEAD/skills/obsidian-markdown"
---

## Activation Contract

Use this skill when the user request matches `obsidian-markdown` or the preserved source description: Create and edit Obsidian Flavored Markdown with wikilinks, embeds, callouts, properties, and other Obsidian-specific syntax. Use when working with .md files in Obsidian, or when the user mentions wikilinks, callouts, frontmatter, tags, embeds, or Obsidian notes.
...
- `references/CALLOUTS.md` - preserved source companion file.
- `references/EMBEDS.md` - preserved source companion file.
- `references/PROPERTIES.md` - preserved source companion file.
