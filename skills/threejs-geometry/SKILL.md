...
metadata:
  ...
  github_url: "https://github.com/cloudai-x/threejs-skills/tree/HEAD/skills/threejs-geometry"
---

## Activation Contract

Use this skill when the user request matches `threejs-geometry` or the preserved source description: Three.js geometry creation - built-in shapes, BufferGeometry, custom geometry, instancing. Use when creating 3D shapes, working with vertices, building custom meshes, or optimizing with instanced rendering.
