...
Use this skill when the user request matches `docker-patterns` or the preserved source description: Docker and Docker Compose patterns for local development, container security, networking, volume strategies, and multi-service orchestration.
