---
name: discord-bot
description: "Trigger: discord-bot, Discord bot development - community management, moderation, notifications, and AI integration. Preserve source workflow with portable agent instructions."
license: MIT
metadata:
...
Use this skill when the user request matches `discord-bot` or the preserved source description: Discord bot development - community management, moderation, notifications, and AI integration
