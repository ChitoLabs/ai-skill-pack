...
- `assets/templates/migration-template.sql` - preserved source companion file.
- `references/README.md` - preserved source companion file.
- `references/schema-design-checklist.md` - preserved source companion file.
