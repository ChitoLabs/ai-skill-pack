...
See `references/layouts/` and the **Layout Gallery** section in `SKILL.md` for the canonical list. Common picks:
...
See `references/styles/` and the **Style Gallery** section in `SKILL.md` for the canonical list. Common picks:
