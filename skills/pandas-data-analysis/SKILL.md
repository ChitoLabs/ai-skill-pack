...
Use this skill when the user request matches `pandas-data-analysis` or the preserved source description: Master data manipulation, analysis, and visualization with Pandas, NumPy, and Matplotlib
...
- `scripts/helper.py` - preserved source companion file.
