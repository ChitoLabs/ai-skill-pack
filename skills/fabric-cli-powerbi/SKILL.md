...
- `references/dax-queries.md` - preserved source companion file.
- `references/gateways.md` - preserved source companion file.
- `references/refresh.md` - preserved source companion file.
- `references/reports.md` - preserved source companion file.
- `references/semantic-models.md` - preserved source companion file.
- `scripts/list_refresh_history.py` - preserved source companion file.
- `scripts/rebind_report.py` - preserved source companion file.
- `scripts/refresh_model.py` - preserved source companion file.
