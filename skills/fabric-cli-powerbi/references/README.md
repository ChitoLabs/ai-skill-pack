...
| File | Description |
|------|-------------|
| [SKILL.md](source-skill.md) | Main skill definition |
| [references/semantic-models.md](./semantic-models.md) | Semantic model operations |
| [references/reports.md](./reports.md) | Report operations |
| [references/refresh.md](./refresh.md) | Refresh operations and troubleshooting |
| [references/dax-queries.md](./dax-queries.md) | DAX query execution |
| [references/gateways.md](./gateways.md) | Gateway and data source management |
