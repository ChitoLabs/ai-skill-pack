---
name: java-docs
description: "Trigger: java-docs, Ensure that Java types are documented with Javadoc comments and follow best practices for documentation. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: github
  adapter: LCubero
...
Use this skill when the user request matches `java-docs` or the preserved source description: Ensure that Java types are documented with Javadoc comments and follow best practices for documentation.
