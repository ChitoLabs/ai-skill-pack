...
Use this skill when the user request matches `android-di-hilt` or the preserved source description: Wire Android dependency injection with Hilt, scopes, testing overrides, and module ownership boundaries.
