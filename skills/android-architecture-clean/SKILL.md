...
Use this skill when the user request matches `android-architecture-clean` or the preserved source description: Apply clean architecture boundaries, use cases, repositories, and lifecycle-aware presentation models in Android projects.
