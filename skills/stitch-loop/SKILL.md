...
Use this skill when the user request matches `stitch-loop` or the preserved source description: Teaches agents to iteratively build websites using Stitch with an autonomous baton-passing loop pattern
...
- `references/examples/SITE.md` - preserved source companion file.
- `references/examples/next-prompt.md` - preserved source companion file.
- `references/resources/baton-schema.md` - preserved source companion file.
- `references/resources/site-template.md` - preserved source companion file.
