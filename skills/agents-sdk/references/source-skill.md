...
### Core
- **[references/state-scheduling.md](state-scheduling.md)** — State persistence, scheduling, SQL
- **[references/callable.md](callable.md)** — RPC methods, streaming, timeouts
- **[references/routing.md](routing.md)** — URL patterns, custom routing, `getAgentByName`
- **[references/configuration.md](configuration.md)** — Wrangler config, bindings, Vite setup

### Chat & Streaming
- **[references/streaming-chat.md](streaming-chat.md)** — AIChatAgent, resumable streams, tools
- **[references/client-sdk.md](client-sdk.md)** — `useAgent`, `useAgentChat`, `AgentClient`
- **[references/server-driven-messages.md](server-driven-messages.md)** — Trigger patterns, `saveMessages`
- **[references/human-in-the-loop.md](human-in-the-loop.md)** — Approval flows, `needsApproval`

### Background Processing
- **[references/workflows.md](workflows.md)** — Durable Workflows integration
- **[references/durable-execution.md](durable-execution.md)** — `runFiber`, `stash`, surviving eviction
- **[references/queue-retries.md](queue-retries.md)** — Built-in queue, retry with backoff

### Integrations
- **[references/mcp.md](mcp.md)** — MCP client and server, transports, securing
- **[references/email.md](email.md)** — Email routing and handling
- **[references/webhooks-push.md](webhooks-push.md)** — Webhooks, push notifications
- **[references/observability.md](observability.md)** — Diagnostics-channel events

### Experimental
- **[references/think.md](think.md)** — `@cloudflare/think` higher-level chat agent
- **[references/voice.md](voice.md)** — `@cloudflare/voice` STT/TTS
- **[references/codemode.md](codemode.md)** — Code Mode for tool orchestration
- **[references/browse-the-web.md](browse-the-web.md)** — CDP browser tools
