...
Plugins are **tool-agnostic**: they describe workflows in terms of categories such as data warehouse, notebook, product analytics, and project tracker rather than specific products. The `.mcp.json` pre-configures specific MCP servers, but any MCP server in that category works.
