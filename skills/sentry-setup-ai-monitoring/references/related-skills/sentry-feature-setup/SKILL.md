...
| Feature | Skill | Path |
|---|---|---|
| AI/LLM monitoring - instrument OpenAI, Anthropic, LangChain, Vercel AI, Google GenAI, Pydantic AI | [`sentry-setup-ai-monitoring`](../../SKILL_TREE.md) | `sentry-setup-ai-monitoring/SKILL.md` |
