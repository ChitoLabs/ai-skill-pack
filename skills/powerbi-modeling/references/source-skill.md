...
- Star schema design: See [STAR-SCHEMA.md](STAR-SCHEMA.md)
- Relationship configuration: See [RELATIONSHIPS.md](RELATIONSHIPS.md)
- DAX measures and naming: See [MEASURES-DAX.md](MEASURES-DAX.md)
- Performance optimization: See [PERFORMANCE.md](PERFORMANCE.md)
- Row-level security: See [RLS.md](RLS.md)
