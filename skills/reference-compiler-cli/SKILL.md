...
Use this skill when the user request matches `reference-compiler-cli` or the preserved source description: Explains the mental model and architecture of the code under `packages/compiler-cli`. You MUST use this skill any time you plan to work with code in `packages/compiler-cli`
