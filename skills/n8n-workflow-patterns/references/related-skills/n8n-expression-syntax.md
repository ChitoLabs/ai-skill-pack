...
For complete error catalog with fixes, see [COMMON_MISTAKES.md](n8n-expression-syntax/references/COMMON_MISTAKES.md)
...
For real workflow examples, see [EXAMPLES.md](n8n-expression-syntax/references/EXAMPLES.md)
...
- [COMMON_MISTAKES.md](n8n-expression-syntax/references/COMMON_MISTAKES.md) - Complete error catalog
- [EXAMPLES.md](n8n-expression-syntax/references/EXAMPLES.md) - Real workflow examples
