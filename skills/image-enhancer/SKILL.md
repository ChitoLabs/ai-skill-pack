...
metadata:
  ...
  github_url: "https://github.com/composiohq/awesome-claude-skills/tree/HEAD/image-enhancer"
---

## Activation Contract

Use this skill when the user request matches `image-enhancer` or the preserved source description: Improves the quality of images, especially screenshots, by enhancing resolution, sharpness, and clarity. Perfect for preparing images for presentations, documentation, or social media posts.
