...
description: "Trigger: wordpress-router. Preserve source workflow with portable agent instructions."
license: Apache-2.0
metadata:
  author: wordpress
  adapter: LCubero
...
- `references/decision-tree.md` - preserved source companion file.
