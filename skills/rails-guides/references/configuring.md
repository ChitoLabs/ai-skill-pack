...
See [Reporting Violations](https://guides.rubyonrails.org/security.html#reporting-violations) in the Security
Guide
...
Can be used to tell Rails that you are [deploying to a subdirectory](https://guides.rubyonrails.org/
...
in `config/credentials.yml.enc`. See the [`secret_key_base` API documentation](https://guides.rubyonrails.org/
...
See [Security Guide](https://guides.rubyonrails.org/security.html#unsafe-query-generation) for more
...
[Action Cable Overview](https://guides.rubyonrails.org/action_cable_overview.html#configuration).
...
Other configuration options are described in the [SQLite3Adapter documentation](https://guides.rubyonrails.org/ https://api.rubyonrails.org/classes/ActiveRecord/ConnectionAdapters/SQLite3Adapter.html).
