...
That covers Zeitwerk naming compliance and other possible error conditions. Please check the [section about testing eager loading](https://guides.rubyonrails.org/testing.html#testing-eager-loading) in the [_Testing Rails Applications_](https://guides.rubyonrails.org/testing.html) guide.
