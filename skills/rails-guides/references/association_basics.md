...
[migration](https://guides.rubyonrails.org/active_record_migrations.html) to ensure that the database is
...
key](https://guides.rubyonrails.org/active_record_composite_primary_keys.html) for the join table in the
...
Guide](https://guides.rubyonrails.org/active_record_callbacks.html).
...
key](https://guides.rubyonrails.org/active_record_composite_primary_keys.html)).
...
- You require [validations](https://guides.rubyonrails.org/active_record_validations.html) or
  [callbacks](https://guides.rubyonrails.org/active_record_callbacks.html) on the join model.
...
guide](https://guides.rubyonrails.org/active_record_composite_primary_keys.html#associations-between-models-with-composite-primary-keys).
...
Migration Guides](https://guides.rubyonrails.org/active_record_migrations.html#creating-a-join-table)
...
* Validate the [presence](https://guides.rubyonrails.org/active_record_validations.html#presence) and
  [absence](https://guides.rubyonrails.org/active_record_validations.html#absence) of associations in more
  cases:
...
You can use any of the standard [querying methods](https://guides.rubyonrails.org/active_record_querying.html)
...
[Normal callbacks](https://guides.rubyonrails.org/active_record_callbacks.html) hook into the life cycle of
...
Guide](https://guides.rubyonrails.org/active_record_callbacks.html#association-callbacks)
