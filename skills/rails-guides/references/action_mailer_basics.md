...
Mailbox](https://guides.rubyonrails.org/action_mailbox_basics.html), which deals with _receiving_ emails.
...
Job](https://guides.rubyonrails.org/active_job_basics.html#action-mailer).
...
in the [Rails caching guide](https://guides.rubyonrails.org/caching_with_rails.html).
...
Guide](https://guides.rubyonrails.org/i18n.html#translations-for-action-mailer-e-mail-subjects) for more.
...
Rails Applications](https://guides.rubyonrails.org/configuring.html#configuring-action-mailer) guide. You can
...
guide](https://guides.rubyonrails.org/testing.html#testing-mailers).
...
Environments](https://guides.rubyonrails.org/configuring.html#creating-rails-environments) for more information
