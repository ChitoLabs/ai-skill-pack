...
You can only initialize an app once. The Railtie [initializers](https://guides.rubyonrails.org/configuring.html#initializers)
...
NOTE: Do not confuse Railtie initializers overall with the [load_config_initializers](https://guides.rubyonrails.org/configuring.html#using-initializer-files)
