...
Overview](https://guides.rubyonrails.org/action_controller_overview.html) guide for an introduction to Action
Controllers.
...
helpers](https://guides.rubyonrails.org/form_helpers.html), so most of the time you don't need to do anything.
...
in the [Security Guide](https://guides.rubyonrails.org/security.html#cross-site-request-forgery-csrf).
...
[configuration](https://guides.rubyonrails.org/configuring.html#config-action-dispatch-show-exceptions) guide.
