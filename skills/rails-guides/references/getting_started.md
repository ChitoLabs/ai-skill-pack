...
Learn more about the Flash in the [Action Controller Overview](https://guides.rubyonrails.org/action_controller_overview.html#the-flash)
...
Next, follow the [Sign Up and Settings tutorial](https://guides.rubyonrails.org/sign_up_and_settings.html) to continue learning.
