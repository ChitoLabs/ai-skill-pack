...
[Action Controller](https://guides.rubyonrails.org/action_controller_overview.html) and Action View work
...
guide](https://guides.rubyonrails.org/caching_with_rails.html#fragment-caching).
...
Rendering in Rails](https://guides.rubyonrails.org/layouts_and_rendering.html) guide.
...
Guide](https://guides.rubyonrails.org/action_view_helpers.html) and the [Action View Form Helpers
Guide](https://guides.rubyonrails.org/form_helpers.html).
...
See the [Rails Internationalization (I18n) API documentation](https://guides.rubyonrails.org/i18n.html) for
more details.
