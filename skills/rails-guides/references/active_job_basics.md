...
guide](https://guides.rubyonrails.org/testing.html#testing-jobs).

Debugging
---------

If you need help figuring out where jobs are coming from, you can enable
[verbose logging](https://guides.rubyonrails.org/debugging_rails_applications.html#verbose-enqueue-logs).
