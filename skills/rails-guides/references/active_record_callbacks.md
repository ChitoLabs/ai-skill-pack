...
updated, and
destroyed](https://guides.rubyonrails.org/active_record_basics.html#crud-reading-and-writing-data). Active
...
section](https://guides.rubyonrails.org/active_record_callbacks.html#after-commit-and-after-rollback) for
...
section](https://guides.rubyonrails.org/active_record_querying.html#dynamic-finders).

Conditional Callbacks
---------------------

As with [validations](https://guides.rubyonrails.org/active_record_validations.html), we can also make the
...
Just as with [validations](https://guides.rubyonrails.org/active_record_validations.html), it is also possible
...
options](https://guides.rubyonrails.org/configuring.html#config-active-record-run-after-transaction-callbacks-in-order-defined)
for more details.
