...
Record](https://guides.rubyonrails.org/active_record_basics.html). Active Record is an ORM (Object Relational
...
View](https://guides.rubyonrails.org/action_view_overview.html) right out of the box.
...
Helpers](https://guides.rubyonrails.org/form_helpers.html) and [Layouts and
Rendering](https://guides.rubyonrails.org/layouts_and_rendering.html)
guides, respectively.
