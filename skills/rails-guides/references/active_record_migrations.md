...
you read the guides for [Active Record Basics](https://guides.rubyonrails.org/active_record_basics.html) and
the [Active Record Associations](https://guides.rubyonrails.org/association_basics.html) to learn more about
...
more about [composite primary keys](https://guides.rubyonrails.org/active_record_composite_primary_keys.html).
...
to many)](https://guides.rubyonrails.org/association_basics.html#the-has-and-belongs-to-many-association) join
...
Keys](https://guides.rubyonrails.org/active_record_composite_primary_keys.html) guide to learn more.
