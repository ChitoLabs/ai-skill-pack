...
existing [Rails credentials](https://guides.rubyonrails.org//security.html#custom-credentials) file using
...
enable [extended
queries](https://guides.rubyonrails.org/configuring.html#config-active-record-encryption-extend-queries) with
...
[filtered](https://guides.rubyonrails.org/configuring.html#config-filter-parameters) out of the Rails logs. So
