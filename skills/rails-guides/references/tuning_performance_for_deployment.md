...
More information about how to configure your application can be found in the [Configuration Guide](https://guides.rubyonrails.org/configuring.html).
...
[jemalloc](https://github.com/facebook/jemalloc).
