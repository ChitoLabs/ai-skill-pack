...
database. [Active Model](https://guides.rubyonrails.org/active_model_basics.html) is commonly used for that in
...
This uses the [Active Support](https://guides.rubyonrails.org/active_support_core_extensions.html#pluralize)
...
* `(association_name)_type` - Stores the type for [polymorphic
  associations](https://guides.rubyonrails.org/association_basics.html#polymorphic-associations).
...
[the fixtures](https://guides.rubyonrails.org/testing.html#the-low-down-on-fixtures) (`my_books.yml`) using the
...
learn more about them in the [Active Record Query](https://guides.rubyonrails.org/active_record_querying.html) guide.
...
guide](https://guides.rubyonrails.org/active_record_migrations.html).
