...
[generate a job](https://guides.rubyonrails.org/active_job_basics.html#create-the-job).
...
with Rails](https://guides.rubyonrails.org/getting_started.html#creating-a-database-model) guide.
...
If you are working with [associations](https://guides.rubyonrails.org/association_basics.html), you can define
...
If there are [multiple writing databases](https://guides.rubyonrails.org/active_record_multiple_databases.html)
...
Authentication](https://guides.rubyonrails.org/getting_started.html#adding-authentication) section, you'll need
...
tests](https://guides.rubyonrails.org/testing.html#helpers-available-for-integration-tests) alongside the
...
[Partial](https://guides.rubyonrails.org/layouts_and_rendering.html#using-partials) templates - usually called
