...
instructions, see the [Installing Ruby on Rails](https://guides.rubyonrails.org/install_ruby_on_rails.html)
guide.
...
can also create [application templates](https://guides.rubyonrails.org/generators.html#application-templates)
...
guide](https://guides.rubyonrails.org/generators.html) for more information.
...
actually add test cases for your code. See the [Testing guide](https://guides.rubyonrails.org/testing.html) for
...
guide](https://guides.rubyonrails.org/asset_pipeline.html#precompiling-assets) for more on precompiling.
...
section](https://guides.rubyonrails.org/active_record_migrations.html#migrations-and-seed-data) of the Active
...
NOTE: Please see the [Migration Guide](https://guides.rubyonrails.org/active_record_migrations.html) for an
...
INFO: Please see the  [Testing Guide](https://guides.rubyonrails.org/testing.html) for explanations and
