...
Use this skill when the user request matches `python-mcp-server-generator` or the preserved source description: Generate a complete MCP server project in Python with tools, resources, and proper configuration
