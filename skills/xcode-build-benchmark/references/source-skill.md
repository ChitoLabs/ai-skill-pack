...
- For the benchmark contract, see [references/benchmarking-workflow.md](benchmarking-workflow.md)
- For the shared artifact format, see [references/benchmark-artifacts.md](benchmark-artifacts.md)
- For the JSON schema, see [schemas/build-benchmark.schema.json](../assets/build-benchmark.schema.json)
