...
|-------|-------------|-----------|
| **Runes** | $state, $derived, $effect, $props, $bindable, $inspect | [runes.md](runes.md) |
| **Snippets** | Replacing slots, {#snippet}, {@render} | [snippets.md](snippets.md) |
| **Events** | onclick handlers, callback props, context API | [events.md](events.md) |
| **TypeScript** | Props typing, generic components | [typescript.md](typescript.md) |
| **Migration** | Svelte 4 to 5, stores to runes | [migration.md](migration.md) |
| **SvelteKit** | Load functions, form actions, SSR, page typing | [sveltekit.md](sveltekit.md) |
| **Performance** | Universal reactivity, avoiding over-reactivity, streaming | [performance.md](performance.md) |
