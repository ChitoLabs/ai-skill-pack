...
Use this skill when the user request matches `api-design-principles` or the preserved source description: Master REST and GraphQL API design principles to build intuitive, scalable, and maintainable APIs that delight developers. Use when designing new APIs, reviewing API specifications, or establishing API design standards.
...
- `assets/api-design-checklist.md` - preserved source companion file.
- `assets/rest-api-template.py` - preserved source companion file.
- `references/graphql-schema-design.md` - preserved source companion file.
- `references/rest-best-practices.md` - preserved source companion file.
